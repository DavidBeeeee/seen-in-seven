...
function publishedPrompt() {
  ...
  const STAGE_CONTRACTS = {
    ...
    7: 'RETURN. Bring the six-part audience canon home through one governing identity transformation that a cold viewer can understand and a returning viewer can recognize. Treat EARLIER SELF from Videos 1-2, FIRST SHIFT from Videos 3-4, FALL from Video 5, and RETURN from Video 6 plus current Video 7 evidence as the complete lived-evidence budget. MEAT performs the complete Return through Hook-and-Eye prose, lets the earned difference emerge from behavior, and ends with the honest unresolved element. CONCLUSION is only a brief one-to-three-sentence homecoming statement of the governing meaning, with no recap, evidence, viewer diagnosis, or second miniature Return. CTA alone carries the relational horizon. Do not create a second thesis, new conflict, trial, revelation, service promise, superiority comparison, pitch, or offer.'
  };
