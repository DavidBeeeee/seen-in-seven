...
function publishedPrompt() {
  ...
  const QUALITY_REVIEW_SYSTEM = [
    ...
    'For Level 2 Video 3, require a literal person to perform the guide function through a question, correction, example, permission, warning, teaching, or demonstration. Build the opening from the concrete discovery scene, not the final reframe. The speaker must receive and test the guidance before the first professional epiphany appears in the CONCLUSION.',
    ...
    'For Level 2 Video 6, build the opening from concrete aftermath or rebuilding evidence. Require the second epiphany to emerge causally from the Video 5 fall, deepen or correct Video 3, and remain unstated until the CONCLUSION.',
