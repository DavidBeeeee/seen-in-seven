...
const INTRO_COPY = {
  ...
  6: {
    L1: {
      ...
      body: "Now reveal what only became clear after the hardest part. This second realization must be earned by that experience, but it does not have to connect to the first realization. Show the aftermath, the understanding it produced, and what became different because you lived it.",
      result: 'Authority',
      framework: [
...
const level2Videos = [
  ...
  },
  {
    ...
    prompts:[
      {label:"What significant way of living or working do you follow that nearly everyone else considers counterintuitive or contrary to common sense?",hint:"Say the belief, standard, choice, or practice plainly. It should matter more to your life or work than a clever opinion and should be specific enough that another person could disagree with it.",key:"v5p0",ph:"Describe the counterintuitive truth or practice you genuinely live by."},
      {label:"What experience, repeated pattern, or evidence made you trust this even when other people did not?",hint:"Tell us what happened before explaining the meaning. This may come from the hardest part you just described, another experience, or a pattern you witnessed over time.",key:"v5p1",ph:"Describe the lived evidence that made this impossible for you to dismiss."},
      {label:"What do you actually do differently because you believe this?",hint:"Choose a visible action, boundary, standard, conversation, habit, or decision. Show that this is something you live by rather than an opinion you only say.",key:"v5p3",ph:"Describe one observable way this changes how you live or work."},
      {label:"Who do you recognize as still following the common-sense approach, and what do you wish they could see?",hint:"Picture one specific person. What are they misreading, repeating, or blaming themselves for? Stay with the perspective you earned rather than turning it into an offer.",key:"v5p4",ph:"Describe who needs this perspective and what it could help them recognize."}
    ],
    legacyPrompts:[
      {label:"Previously saved optional connection to the first realization",key:"v5p2"}
    ],
    compile:v=>`The counterintuitive truth or practice I genuinely live by: ${v.v5p0||'___'}. The lived evidence that made it impossible to dismiss: ${v.v5p1||'___'}. What I visibly do differently because of it: ${v.v5p3||'___'}. Who needs this perspective and what it could help them recognize: ${v.v5p4||'___'}.${v.v5p2 ? ` Previously saved optional connection to the first realization, use only if it naturally fits: ${v.v5p2}.` : ''}`
  },
  {
