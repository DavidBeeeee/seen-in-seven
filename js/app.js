...
const level2Videos = [
  ...
  },
  {
    ...
    prompts:[
      {label:"How did you get into this? Skip the polished professional answer. What is the real story of how you ended up knowing what you know?",hint:"Maybe it started accidentally. Maybe you were solving your own problem. Maybe someone else needed help and you became the person they kept coming back to. What was actually happening in your life when this began?",key:"v1p0",ph:"Tell the real story of how you first got into this."},
      {label:"What detour, wound, obsession, or unlikely chapter shaped the way you understand this work?",hint:"What happened during that part of your life? Give us one concrete detail that someone would never learn from your résumé or professional bio. You do not need to explain what it taught you.",key:"v1p1",ph:"Describe the unlikely chapter and one concrete detail."},
      {label:"What made you dismiss this, resist taking it seriously, or assume it could never become real work for you?",hint:"Answer from what you believed at the time. Why did it seem irrelevant, impractical, unprofessional, or too ordinary to count? What felt more sensible or responsible instead?",key:"v1p2",ph:"Describe why you dismissed it and what felt more sensible instead."}
    ],
  ...
  },
  {
    ...
    prompts:[
      {label:"What is one idea people in your field tend to accept as true, and how did you used to act as if it were true too?",hint:"Keep it to one assumption. What advice, decision, standard, or habit did it shape before you started questioning it?",key:"v2p0",ph:"Describe the idea you accepted and how it affected what you did."},
      {label:"Who gave you a question, example, piece of information, or way of looking at the work that stayed with you?",hint:"Choose one real person. They do not have to be a formal mentor or even know they changed your thinking. What specifically did they say, show, teach, correct, or demonstrate? You do not need to explain the final lesson yet.",key:"v2p5",ph:"Describe one person and the specific lens or idea they gave you."},
      ...
      {label:"After that moment, what was the first smaller thing you could no longer dismiss or keep believing?",hint:"Give us the earliest shift in your own words, even if it was incomplete. Do not turn it into your complete method, philosophy, or answer to everything.",key:"v2p2",ph:"Describe the first smaller truth the evidence made hard to ignore."},
      {label:"Who gets hurt when the old idea keeps being treated as true, and what does that cost look like in real life?",hint:"Think about one recognizable person. What do they waste, lose, postpone, misunderstand, or blame themselves for? Show the human consequence rather than making a general industry argument.",key:"v2p3",ph:"Describe who pays the cost of the old idea and what happens to them."},
      {label:"When you picture someone still living by the old idea, what do you wish they could recognize sooner?",hint:"Speak to what you understand about their situation. Stay with what you want them to see, rather than describing your current service, offer, or way of working.",key:"v2p4",ph:"Describe what you wish one person could recognize before the old idea costs them more."}
    ],
    compile:v=>`The idea I accepted and how it shaped my actions: ${v.v2p0||'___'}. The person who gave me a useful lens: ${v.v2p5||'___'}. The moment the old idea stopped matching the evidence: ${v.v2p1||'___'}. The first smaller truth I could no longer dismiss: ${v.v2p2||'___'}. Who the old idea hurts and what it costs: ${v.v2p3||'___'}. What I wish that person could recognize sooner: ${v.v2p4||'___'}.`
  },
  {
    title:"When The Insight Met Reality",
  ...
  },
  {
    ...
    prompts:[
      {label:"After the hardest part was over, what did you eventually understand that you could not have understood before living through it?",hint:"Say it in your own words. It does not need to sound polished. It should come from what happened, rather than from a separate opinion you already held.",key:"v5p0",ph:"Describe what only became clear after you lived through the difficult experience."},
      {label:"What happened during the aftermath or rebuilding that made this understanding harder and harder to ignore?",hint:"Walk us through the evidence. What did you try, notice, lose, rebuild, stop doing, or finally do differently? Give us what happened before giving us a lesson.",key:"v5p1",ph:"Describe the aftermath evidence that brought the deeper understanding into focus."},
      {label:"Think back to the first thing you saw differently earlier in this story. What could that first realization still not explain once everything fell apart?",hint:"Name the limit you discovered in the earlier idea. What was still missing, incomplete, or unable to help you through the hardest part?",key:"v5p2",ph:"Describe what your first realization could not explain after the fall."},
      {label:"What did you actually change afterward that another person could see in your decisions or work?",hint:"Choose a real action, boundary, standard, conversation, habit, or way of responding. Show the effect of the deeper understanding without turning it into a list of advice.",key:"v5p3",ph:"Describe one observable change you made afterward."},
      {label:"Who do you recognize in the place you were, and what do you wish they could see before repeating what happened to you?",hint:"Picture one specific person. What are they misreading, repeating, or blaming themselves for? Stay with the useful perspective you earned, not an offer or invitation to work with you.",key:"v5p4",ph:"Describe who needs the hard-won perspective and what it could help them recognize."}
    ],
    compile:v=>`What only became clear after the difficult experience: ${v.v5p0||'___'}. The aftermath evidence that brought it into focus: ${v.v5p1||'___'}. What my first realization could not explain: ${v.v5p2||'___'}. The observable change I made afterward: ${v.v5p3||'___'}. Who needs this hard-won perspective and what it could help them recognize: ${v.v5p4||'___'}.`
  },
  {
