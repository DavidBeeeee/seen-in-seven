(function(global) {
  ...
  const ASSIGNMENTS = {
    1: [
      ...
      'Develop only the present-day evidence the Return still needs: one observable change, one honest unfinished element, and the direction the speaker wants to continue. The app will synthesize the earlier identity, decisive turns, fall, elixir, integrated gift, and relational ending from the completed journey.'
    ],
    2: [
      ...
      'Develop only the present-day evidence the Return still needs: one observable change in the speaker\'s work or public voice, one honest unfinished element, and the direction they want to continue. The app will synthesize the earlier expert, decisive turns, fall, elixir, earned professional difference, and relational ending from the completed journey.'
    ]
  };
